...
**Next.js** 학습을 목적으로 제작하게 된 게시판 사이트의 프론트엔드 단입니다.
<a href="https://forestia.vercel.app/">이곳</a>에서 직접 사용해보실 수 있습니다.
...
- **Google OAuth2**를 통해 구글 계정으로 로그인하실 수 있으며, 로그인 시 **게시글, 댓글, 추천/비추** 기능이 활성화됩니다.
