...
**Next.js** 학습을 목적으로 제작하게 된 게시판 사이트 **Forestia**의 프론트엔드 단입니다.
<a href="https://forestia.vercel.app/">이곳</a>에서 게시판을 직접 사용해보실 수 있습니다.
...
- **Google OAuth2**를 통해 구글 계정으로 로그인할 수 있으며, 첫 로그인 시 **JWT** 토큰이 발급되어 DB에 저장됩니다.
